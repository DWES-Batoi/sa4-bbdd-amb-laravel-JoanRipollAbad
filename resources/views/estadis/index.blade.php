...
{{-- Traducción del título de la pestaña --}}
...
<table class="w-full border-collapse border border-gray-300">
  <thead class="bg-gray-200">
    <tr>
      <th class="border border-gray-300 text-black p-2">{{ __('Nom') }}</th>
      <th class="border border-gray-300 text-black p-2">{{ __('Capacitat') }}</th>
    </tr>
  </thead>
  <tbody>
